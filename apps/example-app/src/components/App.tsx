  ...
  return (
    <Stack direction="column" spacing="gap-4">
      <div className='bubble-breaker'>
        ...
        The Swiss government has outlined plans to impose stricter regulations on UBS and other systemically important banks, aiming to prevent a repeat of the financial crisis that occurred during the 2007-9 financial crisis. These plans, which were announced following the rescue of Credit Suisse, are part of a broader effort to ensure the stability of the Swiss banking sector. The government's recommendations, which include 22 measures for direct implementation, are designed to tighten capital requirements for banks deemed "too big to fail" (TBTF). However, the government has not specified the extent of these stricter requirements.
        The proposed regulations come amid concerns that UBS, which is now twice the size of Switzerland's annual economic output, could pose a significant risk to the country's financial stability. If UBS were to fail, there would be no local rivals capable of absorbing it, potentially leading to a bailout and nationalization that could severely impact public finances. The Swiss government has committed to implementing these measures quickly, with plans to present two packages for consideration in the first half of 2025. One package would involve changes at the ordinance level, which can be approved by the government, while the other would be subject to parliamentary review.
        </div>
      </div>
